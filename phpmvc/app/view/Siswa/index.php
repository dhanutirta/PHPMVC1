...
<div class="container mt-5">
    <div class="row">
        <div class="col-6">
            <?php FLasher::flash(); ?>
            <h3 style="color: white; font-weight: bold">Daftar Siswa RPL</h3>
                    ...
                    Tambah Siswa
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-header">
                                    <h5 style="font-weight: bold" class="modal-title" id="exampleModalLabel">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tambah Siswa</h5>
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <button style="width: 25%;" type="button" class="btn btn-success mr-2" data-toggle="modal" data-target="#exampleModal<?=$blog['id']?>">
                            ...
                            <a style="width: 25%;" href="<?= BASE_URL; ?>/siswa/hapus/<?= $blog['id']?> " onclick="return confirm('Yakin?');" class="btn btn-danger mr-2">Hapus</a>
